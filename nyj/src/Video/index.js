...
const Video = () => {
    return (
      <div className='page'>
        ...
        <p className="text2">Wifi the magic that lets you magic you surf the internet  from<br></br>your couch,
       without having to get up and plug in a cord.<br></br>It's like having a personal genie that grants you<br></br>internet accessfrom anywhere in your home.</p>
       </div>
